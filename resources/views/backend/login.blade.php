...
@endif
            ...
            @csrf
                ...
                <input type="password"name="user_password" id="user-password" class="form-control" placeholder="Password" required autofocus="">
                <input type="password"  name="user_password_confirmation"id="user-repeatpass" class="form-control" placeholder="Confirm Password" required autofocus="">
